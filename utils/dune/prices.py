...
QUERY_ID = os.getenv('DUNE_PRICES_QUERY_ID')

dune = DuneClient.from_env()

DATE_FROM = "2025-02-25"
DATE_TO = "2025-03-23"
CHAIN = "ethereum"
PERFORMANCE = "medium"
...
def get_token_prices(
    ...
    print(f"Fetching token price data for {chain} {tokens} from {date_from} to {date_to}")
    query = QueryBase(
		query_id=QUERY_ID,
		params=[
...
def parse_args():
    parser = argparse.ArgumentParser(description="Fetch token daily price candles from Dune Analytics")
